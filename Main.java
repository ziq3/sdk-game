...
public class Main {
    ...
    private static final String GAME_ID = "183098";
        ...
        Emitter.Listener onMapUpdate = new Emitter.Listener() {
            ...
            public void call(Object... args) {
                try {
                    ...
                    //
                    // List<Weapon> HaveThrowable = hero.getInventory().getListThrowable(); //
                    // Throwable
                    ...
                    if (!pickedUpGun) {
                        ...
                        if (currentNode.getX() == nearestWeapon.getX() && currentNode.getY() == nearestWeapon.getY()) {
                            ...
                            for (Player P : OtherPlayer) {
                                for (int indexDiretions = 0; indexDiretions < 4; ++indexDiretions) {
                                    ...
                                    //rangeGun=4
                                    for (int i = 0; i < 4; ++i) {
                                        nearOthers = add(P, DIRECTIONS.get(indexDiretions));
                            ...
                            hero.move(
                                    PathUtils.getShortestPath(gameMap, BlocksNodes, currentNode, nearestWeapon, false));
                        }
                    } else {
                        ...
                        if (!fire_or_move) { // move
                            ...
                            System.out
                                    .println("[Current Hero]:" + currentNode.getX() + " " + currentNode.getY() + "] ");
                            ...
                            System.out.println("[Path]: " + PathUtils.getShortestPath(gameMap, BlocksNodes, currentNode,
                                    nearestPlayerNode, false));
                            hero.move(PathUtils.getShortestPath(gameMap, BlocksNodes, currentNode, nearestPlayerNode,
                                    false));
                        }
